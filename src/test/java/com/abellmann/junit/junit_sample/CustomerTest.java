...
public class CustomerTest {
	...
	public void getName() {
		...
		assertEquals("John", a.customer.w("John").build().getName());
	}
	...
	public void oneNewReleaseStatement() {
		assertEquals(
				...
				a.customer.w("John").w(a.rental.w(a.movie.w(NEW_RELEASE))).build().statement());
	}
	...
	public void allRentalTypesStatement() {
		assertEquals(
				...
				a.customer.w("Pat").w(a.rental.w(a.movie.w(NEW_RELEASE)), a.rental.w(a.movie.w("Scarface").w(REGULAR)),
	...
	public void newReleaseAndRegularStatement() {
		assertEquals(
				...
				a.customer.w("Steve")
						.w(a.rental.w(a.movie.w(NEW_RELEASE)), a.rental.w(a.movie.w("Scarface").w(REGULAR))).build()
						.statement());
	}
	...
	public void oneNewReleaseHtmlStatement() {
		assertEquals("<h1>Rental record for <em>John</em>" + "</h1>\n<p>Godfather 4 9.0</p>\n"
				...
				a.customer.w("John").w(a.rental.w(a.movie.w(NEW_RELEASE))).build().htmlStatement());
	}
	...
	public void allRentalTypesHtmlStatement() {
		assertEquals(
				...
				a.customer.w("Pat").w(a.rental.w(a.movie.w(NEW_RELEASE)), a.rental.w(a.movie.w("Scarface").w(REGULAR)),
						a.rental.w(a.movie.w("Lion King").w(CHILDREN))).build().htmlStatement());
	}
	...
	public void newReleaseAndRegularHtmlStatement() {
		assertEquals(
				"<h1>Rental record for <em>Steve" + "</em></h1>\n<p>Godfather 4 9.0</p>"
						...
						+ "You earned <em>3 frequent renter " + "points</em></p>",
				a.customer.w("Steve")
						.w(a.rental.w(a.movie.w(NEW_RELEASE)), a.rental.w(a.movie.w("Scarface").w(REGULAR))).build()
						.htmlStatement());
	}
